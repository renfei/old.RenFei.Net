package net.renfei.www.common.aspect;

import lombok.extern.slf4j.Slf4j;
import net.renfei.www.common.baseclass.BaseClass;
import net.renfei.www.entity.vo.PerformanceVO;
...
public class PerformanceAspect extends BaseClass {
    ...
    @Pointcut("execution(* net.renfei.www.*..*(..))")
